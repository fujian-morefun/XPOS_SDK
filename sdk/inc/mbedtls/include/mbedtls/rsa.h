 ...
 */
LIB_EXPORT void mbedtls_rsa_init( mbedtls_rsa_context *ctx,
                       int padding,
                       int hash_id);
 ...
 */
LIB_EXPORT int mbedtls_rsa_import( mbedtls_rsa_context *ctx,
                        const mbedtls_mpi *N,
 ...
 * \return         A non-zero error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_import_raw( mbedtls_rsa_context *ctx,
 ...
 *
 */
LIB_EXPORT int mbedtls_rsa_complete( mbedtls_rsa_context *ctx );
 ...
 *
 */
LIB_EXPORT int mbedtls_rsa_export( const mbedtls_rsa_context *ctx,
 ...
 * \return         A non-zero return code on any other failure.
 */
LIB_EXPORT int mbedtls_rsa_export_raw( const mbedtls_rsa_context *ctx,
 ...
 *
 */
LIB_EXPORT int mbedtls_rsa_export_crt( const mbedtls_rsa_context *ctx,
 ...
 */
LIB_EXPORT void mbedtls_rsa_set_padding( mbedtls_rsa_context *ctx, int padding,
                              int hash_id);
 ...
 */
LIB_EXPORT int mbedtls_rsa_gen_key( mbedtls_rsa_context *ctx,
 ...
 *
 */
LIB_EXPORT int mbedtls_rsa_check_pubkey( const mbedtls_rsa_context *ctx );
 ...
 * \return     An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_check_privkey( const mbedtls_rsa_context *ctx );
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_check_pub_priv( const mbedtls_rsa_context *pub,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_public( mbedtls_rsa_context *ctx,
 ...
 *
 */
LIB_EXPORT int mbedtls_rsa_private( mbedtls_rsa_context *ctx,
                 int (*f_rng)(void *, unsigned char *, size_t),
                 void *p_rng,
                 const unsigned char *input,
                 unsigned char *output );
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_pkcs1_encrypt( mbedtls_rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsaes_pkcs1_v15_encrypt( mbedtls_rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode, size_t ilen,
                                 const unsigned char *input,
 ...
 * \return           An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsaes_oaep_encrypt( mbedtls_rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng,
                            int mode,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_pkcs1_decrypt( mbedtls_rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng,
 ...
 *
 */
LIB_EXPORT int mbedtls_rsa_rsaes_pkcs1_v15_decrypt( mbedtls_rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode, size_t *olen,
                                 const unsigned char *input,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsaes_oaep_decrypt( mbedtls_rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng,
                            int mode,
                            const unsigned char *label, size_t label_len,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_pkcs1_sign( mbedtls_rsa_context *ctx,
                    int (*f_rng)(void *, unsigned char *, size_t),
                    void *p_rng,
                    int mode,
...
LIB_EXPORT int mbedtls_rsa_pkcs1_sign_pss( mbedtls_rsa_context *ctx,
							  int (*f_rng)(void *, unsigned char *, size_t),
							  void *p_rng,
							  int mode,
							  mbedtls_md_type_t md_alg,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsassa_pkcs1_v15_sign( mbedtls_rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, size_t),
                               void *p_rng,
                               int mode,
                               mbedtls_md_type_t md_alg,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsassa_pss_sign( mbedtls_rsa_context *ctx,
                         int (*f_rng)(void *, unsigned char *, size_t),
                         void *p_rng,
                         int mode,
                         mbedtls_md_type_t md_alg,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_pkcs1_verify( mbedtls_rsa_context *ctx,
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng,
                      int mode,
                      mbedtls_md_type_t md_alg,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsassa_pkcs1_v15_verify( mbedtls_rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode,
                                 mbedtls_md_type_t md_alg,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsassa_pss_verify( mbedtls_rsa_context *ctx,
                           int (*f_rng)(void *, unsigned char *, size_t),
                           void *p_rng,
                           int mode,
                           mbedtls_md_type_t md_alg,
 ...
 * \return         An \c MBEDTLS_ERR_RSA_XXX error code on failure.
 */
LIB_EXPORT int mbedtls_rsa_rsassa_pss_verify_ext( mbedtls_rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, size_t),
                               void *p_rng,
                               int mode,
                               mbedtls_md_type_t md_alg,
 ...
 */
LIB_EXPORT int mbedtls_rsa_copy( mbedtls_rsa_context *dst, const mbedtls_rsa_context *src );
 ...
 */
LIB_EXPORT void mbedtls_rsa_free( mbedtls_rsa_context *ctx );
 ...
 */
LIB_EXPORT int mbedtls_rsa_self_test( int verbose );
