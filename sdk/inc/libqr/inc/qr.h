 ...
 * サイズ定数
 */
#define QR_SRC_MAX	 400  /* 入力データの最大長 */
#define QR_DIM_MAX   177  /* 1辺のモジュール数の最大値 */
#define QR_VER_MAX    40  /* 型番の最大値 */
#define QR_DWD_MAX  1024  /* データコード語の最大長(型番40/レベルL) */
#define QR_ECW_MAX  1024  /* 誤り訂正コード語の最大長(型番40/レベルH) */
#define QR_CWD_MAX  1024  /* コード語の最大長(型番40) */
...
#define QR_ERR_MAX	  64  /* エラー情報の最大長 */
