#ifndef _OSL_SYSTEM_H_
#define _OSL_SYSTEM_H_
...
#define EXT_FLASH_DEV_DATA3_ADDR				(EX_FLASH_BASE_ADDR + 0x003000)
#define EXT_FLASH_DEV_DATA4_ADDR				(EX_FLASH_BASE_ADDR + 0x004000)

#define EXT_FLASH_TMS_MD5_ADDR					osl_getTmsMd5Addr()
#define EXT_FLASH_TMS_AREA_ADDR					(EXT_FLASH_TMS_MD5_ADDR + 0x001000)

#define EXT_FLASH_HZ_12_ADDR					(EX_FLASH_BASE_ADDR + 0x0D1000)		// 512
#define EXT_FLASH_HZ_16_ADDR					(EX_FLASH_BASE_ADDR + 0x151000)		// 548	
