...
#define MIFARE_CL_CMD_INC		0xc1
#define MIFARE_CL_CMD_DEC		0xc0
#define MIFARE_CL_CMD_RESTORE	0xc2
#define MIFARE_CL_CMD_TRANSFER	0xb0
...
extern int mfcl_increment(struct rfid_protocol_handle *ph, int sector, int operand);
extern int mfcl_decrement(struct rfid_protocol_handle *ph, int sector, int operand);
extern int mfcl_restore(struct rfid_protocol_handle *ph, int sector);
extern int mfcl_transfer(struct rfid_protocol_handle *ph, int sector);
