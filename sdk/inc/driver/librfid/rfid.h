...
//ERROR CODE DEFINE
//
#define		LIBRFID_ERR_SUCCESS				(0)
#define 	LIBRFID_ERR_IO_TIMEOUT			(201)
#define 	LIBRFID_ERR_INTEGRITY_ERROR		(202)
#define		LIBRFID_ERR_COLLISION_ERROR		(203)
#define 	LIBRFID_ERR_PROTOCOL_ERROR		(204)
#define		LIBRFID_ERR_FRAMING_ERROR		(205)
