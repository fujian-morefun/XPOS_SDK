 ...
 */
LIB_EXPORT void pk_init( pk_context *ctx );

/**
 * \brief           Free a pk_context
 */
LIB_EXPORT void pk_free( pk_context *ctx );
 ...
 */
LIB_EXPORT int pk_init_ctx( pk_context *ctx, const pk_info_t *info );
 ...
 */
LIB_EXPORT int pk_init_ctx_rsa_alt( pk_context *ctx, void * key,
 ...
 */
LIB_EXPORT size_t pk_get_size( const pk_context *ctx );
 ...
 *                  1 otherwise.
 */
LIB_EXPORT int pk_can_do( pk_context *ctx, pk_type_t type );
 ...
 */
LIB_EXPORT int pk_verify( pk_context *ctx, md_type_t md_alg,
               const unsigned char *hash, size_t hash_len,
               const unsigned char *sig, size_t sig_len );
 ...
 */
LIB_EXPORT int pk_verify_ext( pk_type_t type, const void *options,
 ...
 * \note            md_alg may be POLARSSL_MD_NONE, only if hash_len != 0
 */
LIB_EXPORT int pk_sign( pk_context *ctx, md_type_t md_alg,
             const unsigned char *hash, size_t hash_len,
             unsigned char *sig, size_t *sig_len,
             int (*f_rng)(void *, unsigned char *, size_t), void *p_rng );
 ...
 * \return          0 on success, or a specific error code.
 */
LIB_EXPORT int pk_decrypt( pk_context *ctx,
 ...
 * \return          0 on success, or a specific error code.
 */
LIB_EXPORT int pk_encrypt( pk_context *ctx,
                const unsigned char *input, size_t ilen,
                unsigned char *output, size_t *olen, size_t osize,
                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng );
 ...
 */
LIB_EXPORT int pk_debug( const pk_context *ctx, pk_debug_item *items );
 ...
 */
LIB_EXPORT const char * pk_get_name( const pk_context *ctx );
 ...
 */
LIB_EXPORT int pk_parse_key( pk_context *ctx,
 ...
 * \return          0 if successful, or a specific PK or PEM error code
 */
LIB_EXPORT int pk_parse_public_key( pk_context *ctx,
                         const unsigned char *key, size_t keylen );
 ...
 * \return          0 if successful, or a specific PK or PEM error code
 */
LIB_EXPORT int pk_parse_keyfile( pk_context *ctx,
 ...
 * \return          0 if successful, or a specific PK or PEM error code
 */
LIB_EXPORT int pk_parse_public_keyfile( pk_context *ctx, const char *path );
 ...
 *                  error code
 */
LIB_EXPORT int pk_write_key_der( pk_context *ctx, unsigned char *buf, size_t size );
 ...
 *                  error code
 */
LIB_EXPORT int pk_write_pubkey_der( pk_context *ctx, unsigned char *buf, size_t size );
 ...
 */
LIB_EXPORT int pk_write_pubkey_pem( pk_context *ctx, unsigned char *buf, size_t size );
 ...
 * \return          0 successful, or a specific error code
 */
LIB_EXPORT int pk_write_key_pem( pk_context *ctx, unsigned char *buf, size_t size );
 ...
 */
LIB_EXPORT int pk_parse_subpubkey( unsigned char **p, const unsigned char *end,
                        pk_context *pk );
#endif /* POLARSSL_PK_PARSE_C */
 ...
 */
LIB_EXPORT int pk_write_pubkey( unsigned char **p, unsigned char *start,
                     const pk_context *key );


LIB_EXPORT int pk_parse_key_pkcs8_encrypted_der(
									 pk_context *pk,
									 const unsigned char *key, size_t keylen,
									 const unsigned char *pwd, size_t pwdlen );
