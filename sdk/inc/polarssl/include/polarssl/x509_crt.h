 ...
 */
LIB_EXPORT int x509_crt_parse( x509_crt *chain, const unsigned char *buf, size_t buflen );
 ...
 *                 case of an error.
 */
LIB_EXPORT int x509_crt_info( char *buf, size_t size, const char *prefix,
                   const x509_crt *crt );
 ...
 */
LIB_EXPORT int x509_crt_verify( x509_crt *crt,
                     x509_crt *trust_ca,
                     x509_crl *ca_crl,
 ...
 */
LIB_EXPORT void x509_crt_init( x509_crt *crt );
 ...
 */
LIB_EXPORT void x509_crt_free( x509_crt *crt );
