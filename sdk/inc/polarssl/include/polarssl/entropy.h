 ...
 */
LIB_EXPORT void entropy_init( entropy_context *ctx );
 ...
 */
LIB_EXPORT void entropy_free( entropy_context *ctx );
 ...
 * \return          0 if successful, or POLARSSL_ERR_ENTROPY_SOURCE_FAILED
 */
LIB_EXPORT int entropy_func( void *data, unsigned char *output, size_t len );
