 ...
 */
LIB_EXPORT void rsa_init( rsa_context *ctx,
               int padding,
               int hash_id);
 ...
 * \param hash_id  RSA_PKCS_V21 hash identifier
 */
LIB_EXPORT void rsa_set_padding( rsa_context *ctx, int padding, int hash_id);
 ...
 */
LIB_EXPORT int rsa_gen_key( rsa_context *ctx,
 ...
 * \return         0 if successful, or an POLARSSL_ERR_RSA_XXX error code
 */
LIB_EXPORT int rsa_check_pubkey( const rsa_context *ctx );
 ...
 * \return         0 if successful, or an POLARSSL_ERR_RSA_XXX error code
 */
LIB_EXPORT int rsa_check_privkey( const rsa_context *ctx );
 ...
 */
LIB_EXPORT int rsa_public( rsa_context *ctx,
 ...
 *                 enough (eg. 128 bytes if RSA-1024 is used).
 */
LIB_EXPORT int rsa_private( rsa_context *ctx,
                 int (*f_rng)(void *, unsigned char *, size_t),
                 void *p_rng,
                 const unsigned char *input,
                 unsigned char *output );
 ...
 */
LIB_EXPORT int rsa_pkcs1_encrypt( rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
LIB_EXPORT int rsa_rsaes_pkcs1_v15_encrypt( rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode, size_t ilen,
                                 const unsigned char *input,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
LIB_EXPORT int rsa_rsaes_oaep_encrypt( rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng,
                            int mode,
 ...
 *                 an error is thrown.
 */
LIB_EXPORT int rsa_pkcs1_decrypt( rsa_context *ctx,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng,
 ...
 *                 an error is thrown.
 */
LIB_EXPORT int rsa_rsaes_pkcs1_v15_decrypt( rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode, size_t *olen,
                                 const unsigned char *input,
 ...
 *                 an error is thrown.
 */
LIB_EXPORT int rsa_rsaes_oaep_decrypt( rsa_context *ctx,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng,
                            int mode,
                            const unsigned char *label, size_t label_len,
 ...
 */
LIB_EXPORT int rsa_pkcs1_sign( rsa_context *ctx,
                    int (*f_rng)(void *, unsigned char *, size_t),
                    void *p_rng,
                    int mode,
                    md_type_t md_alg,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
LIB_EXPORT int rsa_rsassa_pkcs1_v15_sign( rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, size_t),
                               void *p_rng,
                               int mode,
                               md_type_t md_alg,
 ...
 */
LIB_EXPORT int rsa_rsassa_pss_sign( rsa_context *ctx,
                         int (*f_rng)(void *, unsigned char *, size_t),
                         void *p_rng,
                         int mode,
                         md_type_t md_alg,
 ...
 */
LIB_EXPORT int rsa_pkcs1_verify( rsa_context *ctx,
                      int (*f_rng)(void *, unsigned char *, size_t),
                      void *p_rng,
                      int mode,
                      md_type_t md_alg,
 ...
 *                 of ctx->N (eg. 128 bytes if RSA-1024 is used).
 */
LIB_EXPORT int rsa_rsassa_pkcs1_v15_verify( rsa_context *ctx,
                                 int (*f_rng)(void *, unsigned char *, size_t),
                                 void *p_rng,
                                 int mode,
                                 md_type_t md_alg,
 ...
 */
LIB_EXPORT int rsa_rsassa_pss_verify( rsa_context *ctx,
                           int (*f_rng)(void *, unsigned char *, size_t),
                           void *p_rng,
                           int mode,
                           md_type_t md_alg,
 ...
 */
LIB_EXPORT int rsa_rsassa_pss_verify_ext( rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, size_t),
                               void *p_rng,
                               int mode,
                               md_type_t md_alg,
 ...
 */
LIB_EXPORT int rsa_copy( rsa_context *dst, const rsa_context *src );
 ...
 */
LIB_EXPORT void rsa_free( rsa_context *ctx );
 ...
 */
LIB_EXPORT int rsa_self_test( int verbose );
