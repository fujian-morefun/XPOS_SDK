 ...
 */
LIB_EXPORT void md5_init( md5_context *ctx );
 ...
 */
LIB_EXPORT void md5_free( md5_context *ctx );
 ...
 */
LIB_EXPORT void md5_starts( md5_context *ctx );
 ...
 */
LIB_EXPORT void md5_update( md5_context *ctx, const unsigned char *input, size_t ilen );
 ...
 */
LIB_EXPORT void md5_finish( md5_context *ctx, unsigned char output[16] );
