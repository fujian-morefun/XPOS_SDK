 ...
 */
LIB_EXPORT const ecp_curve_info *ecp_curve_list( void );
 ...
 */
LIB_EXPORT const ecp_group_id *ecp_grp_id_list( void );
 ...
 */
LIB_EXPORT const ecp_curve_info *ecp_curve_info_from_grp_id( ecp_group_id grp_id );
 ...
 * \return          The associated curve information or NULL
 */
LIB_EXPORT const ecp_curve_info *ecp_curve_info_from_tls_id( uint16_t tls_id );
 ...
 * \return          The associated curve information or NULL
 */
LIB_EXPORT const ecp_curve_info *ecp_curve_info_from_name( const char *name );

/**
 * \brief           Initialize a point (as zero)
 */
LIB_EXPORT void ecp_point_init( ecp_point *pt );

/**
 * \brief           Initialize a group (to something meaningless)
 */
LIB_EXPORT void ecp_group_init( ecp_group *grp );

/**
 * \brief           Initialize a key pair (as an invalid one)
 */
LIB_EXPORT void ecp_keypair_init( ecp_keypair *key );

/**
 * \brief           Free the components of a point
 */
LIB_EXPORT void ecp_point_free( ecp_point *pt );

/**
 * \brief           Free the components of an ECP group
 */
LIB_EXPORT void ecp_group_free( ecp_group *grp );

/**
 * \brief           Free the components of a key pair
 */
LIB_EXPORT void ecp_keypair_free( ecp_keypair *key );
 ...
 */
LIB_EXPORT int ecp_copy( ecp_point *P, const ecp_point *Q );
 ...
 *                  POLARSSL_ERR_MPI_MALLOC_FAILED if memory allocation failed
 */
LIB_EXPORT int ecp_group_copy( ecp_group *dst, const ecp_group *src );
 ...
 *                  POLARSSL_ERR_MPI_MALLOC_FAILED if memory allocation failed
 */
LIB_EXPORT int ecp_set_zero( ecp_point *pt );
 ...
 */
LIB_EXPORT int ecp_is_zero( ecp_point *pt );
 ...
 */
LIB_EXPORT int ecp_point_read_string( ecp_point *P, int radix,
 ...
 */
LIB_EXPORT int ecp_point_write_binary( const ecp_group *grp, const ecp_point *P,
 ...
 *                  that.
 */
LIB_EXPORT int ecp_point_read_binary( const ecp_group *grp, ecp_point *P,
 ...
 *                  POLARSSL_ERR_ECP_BAD_INPUT_DATA if input is invalid
 */
LIB_EXPORT int ecp_tls_read_point( const ecp_group *grp, ecp_point *pt,
 ...
 *                  or POLARSSL_ERR_ECP_BUFFER_TOO_SMALL
 */
LIB_EXPORT int ecp_tls_write_point( const ecp_group *grp, const ecp_point *pt,
                         int format, size_t *olen,
 ...
 */
LIB_EXPORT int ecp_group_read_string( ecp_group *grp, int radix,
 ...
 */
LIB_EXPORT int ecp_use_known_dp( ecp_group *grp, ecp_group_id index );
 ...
 *                  POLARSSL_ERR_ECP_BAD_INPUT_DATA if input is invalid
 */
LIB_EXPORT int ecp_tls_read_group( ecp_group *grp, const unsigned char **buf, size_t len );
 ...
 *                  or POLARSSL_ERR_ECP_BUFFER_TOO_SMALL
 */
LIB_EXPORT int ecp_tls_write_group( const ecp_group *grp, size_t *olen,
                         unsigned char *buf, size_t blen );
 ...
 *                  Curve25519.
 */
LIB_EXPORT int ecp_add( const ecp_group *grp, ecp_point *R,
 ...
 *                  Curve25519.
 */
LIB_EXPORT int ecp_sub( const ecp_group *grp, ecp_point *R,
             const ecp_point *P, const ecp_point *Q );
 ...
 */
LIB_EXPORT int ecp_mul( ecp_group *grp, ecp_point *R,
 ...
 */
LIB_EXPORT int ecp_check_pubkey( const ecp_group *grp, const ecp_point *pt );
 ...
 *                  ecdh_context of ecdsa_context.
 */
LIB_EXPORT int ecp_check_privkey( const ecp_group *grp, const mpi *d );
 ...
 *                  ecdh_context of ecdsa_context.
 */
LIB_EXPORT int ecp_gen_keypair( ecp_group *grp, mpi *d, ecp_point *Q,
 ...
 *                  or a POLARSSL_ERR_ECP_XXX or POLARSSL_MPI_XXX error code
 */
LIB_EXPORT int ecp_gen_key( ecp_group_id grp_id, ecp_keypair *key,
                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng );
