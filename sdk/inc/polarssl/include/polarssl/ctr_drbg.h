 ...
 */
LIB_EXPORT int ctr_drbg_init( ctr_drbg_context *ctx,
                   int (*f_entropy)(void *, unsigned char *, size_t),
                   void *p_entropy,
                   const unsigned char *custom1,
                   size_t len );
 ...
 */
LIB_EXPORT void ctr_drbg_free( ctr_drbg_context *ctx );
 ...
 *                      POLARSSL_ERR_CTR_DRBG_REQUEST_TOO_BIG
 */
LIB_EXPORT int ctr_drbg_random( void *p_rng,
                     unsigned char *output, size_t output_len );
